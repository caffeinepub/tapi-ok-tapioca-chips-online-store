...
import { Mail, MapPin, Phone, Clock, Lightbulb } from 'lucide-react';
import { useSubmitContactForm, useSubmitIdea } from '../hooks/useQueries';
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-2">
                <Label htmlFor="name" className="text-base text-foreground">{t.name}</Label>
                <Input
                  id="name"
              ...
              <div className="space-y-2">
                <Label htmlFor="email" className="text-base text-foreground">{t.email}</Label>
                <Input
                  id="email"
                  type="email"
              ...
              <div className="space-y-2">
                <Label htmlFor="message" className="text-base text-foreground">{t.message}</Label>
                <Textarea
                  id="message"
          ...
          <Card className="transition-all duration-500 hover:shadow-2xl border-2 hover:border-brand/50">
            ...
            <CardContent>
              <div className="p-4 rounded-lg bg-gradient-to-br from-brand/10 to-brand/5 border border-brand/20">
                <p className="text-center text-lg font-bold text-brand mb-1">
                  {t.open247}
                </p>
        ...
        <Card className="transition-all duration-700 hover:shadow-2xl border-2 hover:border-brand/50 bg-gradient-to-br from-background to-brand/5">
          ...
          <CardContent>
            <form onSubmit={handleIdeaSubmit} className="space-y-6">
              <div className="space-y-2">
                <Label htmlFor="ideaName" className="text-base text-foreground">{t.name}</Label>
                <Input
                  id="ideaName"
                  placeholder={t.yourName}
                  value={ideaName}
              ...
              <div className="space-y-2">
                <Label htmlFor="ideaEmail" className="text-base text-foreground">{t.emailOptional}</Label>
                <Input
                  id="ideaEmail"
                  type="email"
                  placeholder={t.yourEmail}
              ...
              <div className="space-y-2">
                <Label htmlFor="ideaMessage" className="text-base text-foreground">{t.yourIdea}</Label>
                <Textarea
                  id="ideaMessage"
