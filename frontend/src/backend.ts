...
import type { AuthUserProfile as _AuthUserProfile, Cart as _Cart, ExternalBlob as _ExternalBlob, FeedbackSubmission as _FeedbackSubmission, GeneratedContent as _GeneratedContent, IdeaSubmission as _IdeaSubmission, Order as _Order, Product as _Product, ProductTranslations as _ProductTranslations, StripeSessionStatus as _StripeSessionStatus, UserAccount as _UserAccount, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createGeneratedContent(arg0: bigint, arg1: string, arg2: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.createGeneratedContent(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createUserAccount(arg0: string, arg1: string, arg2: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.createUserAccount(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllFeedbacks(): Promise<Array<FeedbackSubmission>> {
        if (this.processError) {
            try {
    ...
    async getAllGeneratedContent(): Promise<Array<GeneratedContent>> {
        if (this.processError) {
            try {
    ...
    async getCallerUserProfile(): Promise<AuthUserProfile | null> {
        if (this.processError) {
            try {
    ...
    async getContentByUserId(arg0: bigint): Promise<Array<GeneratedContent>> {
        if (this.processError) {
            try {
                const result = await this.actor.getContentByUserId(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getFeedbackById(arg0: bigint): Promise<FeedbackSubmission | null> {
        if (this.processError) {
            try {
    ...
    async getGeneratedContentById(arg0: bigint): Promise<GeneratedContent | null> {
        if (this.processError) {
            try {
    ...
    async getUserAccountById(arg0: bigint): Promise<UserAccount | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getUserAccountById(arg0);
    ...
    async getUserProfile(arg0: Principal): Promise<AuthUserProfile | null> {
        if (this.processError) {
            try {
    ...
    async saveCallerUserProfile(arg0: AuthUserProfile): Promise<void> {
        if (this.processError) {
            try {
    ...
    async submitFeedback(arg0: bigint | null, arg1: string, arg2: string, arg3: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.submitFeedback(to_candid_opt_n39(this._uploadFile, this._downloadFile, arg0), arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitIdea(arg0: string, arg1: string | null, arg2: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.submitIdea(arg0, to_candid_opt_n40(this._uploadFile, this._downloadFile, arg1), arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateUserAccount(arg0: bigint, arg1: string, arg2: string, arg3: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateUserAccount(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_FeedbackSubmission_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _FeedbackSubmission): FeedbackSubmission {
    return from_candid_record_n16(_uploadFile, _downloadFile, value);
}
function from_candid_IdeaSubmission_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _IdeaSubmission): IdeaSubmission {
...
function from_candid_opt_n21(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_AuthUserProfile]): AuthUserProfile | null {
    return value.length === 0 ? null : value[0];
}
function from_candid_opt_n24(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Cart]): Cart | null {
    return value.length === 0 ? null : value[0];
}
function from_candid_opt_n25(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_FeedbackSubmission]): FeedbackSubmission | null {
    return value.length === 0 ? null : from_candid_FeedbackSubmission_n15(_uploadFile, _downloadFile, value[0]);
}
function from_candid_opt_n26(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_GeneratedContent]): GeneratedContent | null {
    return value.length === 0 ? null : value[0];
}
...
function from_candid_opt_n38(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_UserAccount]): UserAccount | null {
    return value.length === 0 ? null : value[0];
}
...
function from_candid_vec_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_FeedbackSubmission>): Array<FeedbackSubmission> {
    return value.map((x)=>from_candid_FeedbackSubmission_n15(_uploadFile, _downloadFile, x));
}
function from_candid_vec_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_IdeaSubmission>): Array<IdeaSubmission> {
    return value.map((x)=>from_candid_IdeaSubmission_n18(_uploadFile, _downloadFile, x));
}
